    ...
    <div class="card-body">
        <form action="{{url('update-product/'.$products->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class = "col-md-6 mb-3">
                    <lablel for="">Original Price</lablel>
                    <input type="number"class="form-control" value="{{$products->oraginal_price}}" name="oraginal_price">
                </div>
                <div class = "col-md-6 mb-3">
                    <lablel for="">Selling Price</lablel>
                    <input type="number"class="form-control" value="{{$products->selling_price}}" name="selling_price">
                </div>
                <div class = "col-md-6 mb-3">
                    <lablel for="">Tax</lablel>
                    <input type="number" class="form-control" value="{{$products->tax}}" name="tax">
                </div>
                <div class = "col-md-6 mb-3">
                    <lablel for="">Quantity</lablel>
                ...
                <div class="col-md-6 mb-3">
                 ...
                 <div class="col-md-6 mb-3">
                     <label for="">Trnding</label>
                    <input type="checkbox"  {{$products->trending == "1" ? 'checked' :''}} name="popular">
                 </div>
                 <div class="col-md-12 mb-3">
